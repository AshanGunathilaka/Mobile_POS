            ...
            <footer className="py-10 px-6 border-t border-slate-200 dark:border-slate-800">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-slate-500">
                                Open-source POS for small businesses
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-6 text-sm text-slate-500 dark:text-slate-400">
                        ...
                        <Link href="/documentation" className="hover:text-primary-500 transition-colors">
                            Documentation
                        </Link>
                        <Link href="/roadmap" className="hover:text-primary-500 transition-colors">
                            Roadmap
                        </Link>
                        <Link href="/contributing" className="hover:text-primary-500 transition-colors">
                            Contributing
                        </Link>
