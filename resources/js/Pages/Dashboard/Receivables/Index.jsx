...
export default function ReceivablesIndex({ receivables, filters = {} }) {
    ...
    useEffect(() => {
        ...
        fetch(route("receivables.aging"))
            ...
            .catch(() => {
                setLoadingAging(false);
                toast.error("Failed memuat data aging");
            });
    }, [activeTab]);
                ...
                {activeTab === "aging" ? (
                            ...
                            <>
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
                                        <p className="text-xs font-medium text-slate-500 uppercase tracking-wide">Total Receivable</p>
                                        <p className="mt-2 text-2xl font-bold text-slate-900 dark:text-white">
                                            {formatCurrency(agingData.collection_rate?.total_receivables_amount || 0)}
                                        </p>
                                    </div>
                                    <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
                                        <p className="text-xs font-medium text-slate-500 uppercase tracking-wide">Already Paid</p>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                                    <div className="md:col-span-2 rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
                                        <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Aging Receivable</h3>
                                    ...
                                    <div className="md:col-span-3 rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
                                        ...
                                        <div className="space-y-3">
                                            {agingData.top_customers?.length > 0 ? (
                                                ...
                                                <p className="text-sm text-slate-500 text-center py-4">No receivables yet.</p>
                                            )}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <>
                        ...
                        >
                            <div className="relative w-full">
                                ...
                                <input
                                    ...
                                    placeholder="Search invoice / nomor nota"
                        ...
                        <div className="flex justify-between items-center text-sm text-slate-500">
                            <div>
                                Showing {rows.length} of {receivables?.total || 0} data
                            </div>
