...
export default function Index({
        ...
        return [
            {
                value: "cash",
                label: "Cash",
                description: "Cash payment directly at the cashier.",
            },
            ...options,
        ];
    }, [paymentGateways]);
    ...
    const handleHoldCart = async (label = null) => {
        ...
        router.post(
            ...
            { label },
            {
                ...
                onError: (errors) => {
                    toast.error(errors?.message || "Failed to hold transaction");
                    setIsHolding(false);
                },
            }
        );
    ...
    const handleSubmitTransaction = () => {
        ...
        if (!selectedCustomer?.id) {
            toast.error("Select customer terlebih dahulu");
            return;
        }

        if (payLater && !dueDate) {
            toast.error("Enter a due date for pay later transactions.");
            return;
        }
