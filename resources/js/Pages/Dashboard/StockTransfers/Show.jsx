...
const formatDateTime = (value) => {
    if (!value) return "-";
    return new Intl.DateTimeFormat("en-LK", { dateStyle: "full", timeStyle: "short" }).format(new Date(value));
};
...
const statusBadge = (status) => {
    ...
    const labels = { draft: "Draft", in_transit: "In Transit", completed: "Completed", cancelled: "Cancel" };
