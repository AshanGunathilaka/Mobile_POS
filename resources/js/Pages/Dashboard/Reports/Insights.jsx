        ...
        <>
            ...
            <div className="space-y-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <SummaryCard
                        title="Item Terjual"
                        value={(summary?.items_sold ?? 0).toLocaleString("en-LK")}
                        description={`Discount manual ${formatCurrency(summary?.manual_discount_total ?? 0)}`}
                        icon={IconPackage}
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    <SummaryCard
                        ...
                        description={`${repeatSummary.new_customers ?? 0} new customers`}
                        icon={IconUsers}
                    ...
                    <SummaryCard
                        ...
                        description={`${repeatSummary.repeat_customers ?? 0} customer repeat`}
                        icon={IconTrendingUp}
                ...
                <Table.Card title="Stock Coverage Analysis">
                    <div className="mb-4 grid gap-3 md:grid-cols-4">
                        <div className="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800/60">
                            ...
                            <p className="mt-2 text-xl font-semibold text-slate-900 dark:text-white">
                                {(stockCoverageSummary.critical ?? 0).toLocaleString("en-LK")}
                            </p>
                        </div>
                        <div className="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800/60">
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                            ...
                            <p className="mt-2 text-xl font-semibold text-slate-900 dark:text-white">
                                {(stockCoverageSummary.low ?? 0).toLocaleString("en-LK")}
                            </p>
                        </div>
                        <div className="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800/60">
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                            ...
                            <p className="mt-2 text-xl font-semibold text-slate-900 dark:text-white">
                                {(stockCoverageSummary.healthy ?? 0).toLocaleString("en-LK")}
                            </p>
                        </div>
                        <div className="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800/60">
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <Table.Card title="Promo Active Monitor">
                        <div className="mb-4 grid gap-3 md:grid-cols-2">
                            ...
                            <div className="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800/60">
                                ...
                                <p className="mt-2 text-xl font-semibold text-slate-900 dark:text-white">
                                    {(promoSummary.scheduled ?? 0).toLocaleString("en-LK")}
                                </p>
                            </div>
                        </div>
                            ...
                            {Object.entries(promoSummary.by_kind || {}).map(
                                ([key, count]) => (
                                    ...
                                    >
                                        ...
                                        {Number(count).toLocaleString("en-LK")}
                                    </span>
                                )
                            )}
                        </div>
                        ...
                        <Table>
                            <Table.Thead>
                                <tr>
                                    ...
                                    <Table.Th className="text-right">Total Spend</Table.Th>
                                </tr>
                            </Table.Thead>
                            <Table.Tbody>
