...
export default function Show({ order }) {
    ...
    const placeOrder = () => {
        router.post(route("purchase-orders.place", order.id), {}, {
            preserveScroll: true,
            onSuccess: () => toast.success("PO successfully dipesan"),
            onError: () => toast.error("Failed memesan PO"),
        });
    };
                            ...
                            <Table.Tbody>
                                {order.items.length > 0 ? (
                                    ...
                                    <Table.Empty colSpan={6} message={
                                        <div className="text-slate-500 dark:text-slate-400">No items on this purchase order.</div>
                                    }>
