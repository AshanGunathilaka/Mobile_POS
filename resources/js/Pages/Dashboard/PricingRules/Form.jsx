...
const customerScopeOptions = [
    ...
    { value: "walk_in", label: "Tanpa Customer / Umum" },
    { value: "registered", label: "Customer Registered" },
...
const discountTypeOptions = [
    ...
    { value: "fixed_price", label: "Price Final" },
];
                                ...
                                <div className="grid gap-3 md:grid-cols-3">
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800">
                                        ...
                                        <p className="mt-1 text-lg font-semibold text-slate-900 dark:text-white">
                                            LKR {Number(previewState.data.summary.base_subtotal || 0).toLocaleString("en-LK")}
                                        </p>
                                    </div>
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800">
                                        <p className="text-xs uppercase tracking-wide text-slate-500">
                                        ...
                                        <p className="mt-1 text-lg font-semibold text-rose-600 dark:text-rose-300">
                                            LKR {Number(previewState.data.summary.promo_discount_total || 0).toLocaleString("en-LK")}
                                        </p>
                                    </div>
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800">
                                        <p className="text-xs uppercase tracking-wide text-slate-500">
                                        ...
                                        <p className="mt-1 text-lg font-semibold text-slate-900 dark:text-white">
                                            LKR {Number(previewState.data.summary.subtotal_after_promo || 0).toLocaleString("en-LK")}
                                        </p>
                                    </div>
                                </div>
                                            ...
                                            {previewGroups.map((group) => (
                                                ...
                                                >
                                                    ...
                                                    <span className="text-rose-600 dark:text-rose-300">
                                                        -LKR {Number(group.discount_total || 0).toLocaleString("en-LK")}
                                                    </span>
                                                </div>
                                            ))}
                                        </div>
