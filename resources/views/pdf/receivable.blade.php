    ...
    <div class="sheet">
        <div class="header">
            <div class="store">
                ...
                <div class="store-info">
                    ...
                    <div class="muted">{{ $store['phone'] ? 'Phone: '.$store['phone'].' • ' : '' }}{{ $store['email'] }}</div>
                </div>
            </div>
            <div class="doc">
                <div class="badge">Credit Sale</div>
                <div class="doc-number">{{ $receivable->invoice }}</div>
                <div class="muted">Due date: {{ $receivable->due_date ?? '-' }}</div>
            </div>
        </div>
        ...
        <div class="section grid-2">
            <div>
                ...
                <div style="font-weight:700; font-size:14px;">{{ $receivable->customer->name ?? 'Walk-in' }}</div>
        ...
        <div class="section">
            ...
            <table>
                ...
                @empty
                    <tr><td colspan="3" style="color:#94a3b8; text-align:center;">No payments yet</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
