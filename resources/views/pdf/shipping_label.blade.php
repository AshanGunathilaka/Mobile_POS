@php
    $formatPrice = fn($v) => 'LKR ' . number_format($v ?? 0, 2, '.', ',');
...
<body>
    <div class="container">
            ...
            <tr>
                <td style="padding-right: 5pt; width: 65%;">
                    <div class="section-box">
                        ...
                        <div class="text-bold">{{ $transaction->customer->name ?? 'Walk-in' }}</div>
        ...
        <div class="title-label" style="margin-top: 10pt;">Product List</div>
