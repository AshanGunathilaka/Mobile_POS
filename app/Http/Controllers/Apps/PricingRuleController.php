...
class PricingRuleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->auditLogService->log(
            ...
            auditable: $rule,
            description: 'Promotion/pricing rule created.',
    ...
    public function update(Request $request, PricingRule $pricingRule)
    {
        ...
        $this->auditLogService->log(
            ...
            description: 'Promotion/pricing rule updated.',
            before: $before,
    ...
    public function destroy(PricingRule $pricingRule)
    {
        ...
        $this->auditLogService->log(
            ...
            module: 'pricing_rules',
            auditable: $pricingRule,
            description: 'Promotion/pricing rule deleted.',
            before: $before
        );
    ...
    private function formPayload(): array
    {
        return [
            ...
            'kindOptions' => [
                ['value' => PricingRule::KIND_STANDARD_DISCOUNT, 'label' => 'Discount Standar'],
                ['value' => PricingRule::KIND_QTY_BREAK, 'label' => 'Price Grosir / Qty Break'],
