...
class SettingController extends Controller
{
    ...
    public function updateStoreProfile(Request $request)
    {
        ...
        Setting::set('store_name', $request->store_name, 'Store name');
        Setting::set('store_address', $request->store_address, 'Store address');
        Setting::set('store_phone', $request->store_phone, 'Store phone');
        Setting::set('store_email', $request->store_email, 'Store email');
        Setting::set('store_website', $request->store_website, 'Store website');
        Setting::set('store_city', $request->store_city, 'Store city');
        Setting::set('store_logo', $logoPath, 'Store logo');
        Setting::set('store_npwp', $request->store_npwp, 'Store tax ID');
        Setting::set('store_nib', $request->store_nib, 'Store business registration no.');
        Setting::set('tax_default_rate', $request->tax_default_rate, 'Default tax rate (%)');
