...
class CustomerController extends Controller
{
    ...
    public function storeAjax(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Failed menambahkan customer',
                'errors' => [],
            ], 500);
        }
    }
    ...
    public function upgradeToMember(Request $request, Customer $customer)
    {
        ...
        if ($request->expectsJson()) {
            return response()->json([
                'success' => true,
                'message' => 'Customer successfully di-upgrade menjadi member.',
                'customer' => [
                    'id' => $customer->id,
                    'name' => $customer->name,
                    'no_telp' => $customer->no_telp,
        ...
        return back()->with('success', 'Customer successfully di-upgrade menjadi member.');
    }
