...
class CashierShiftController extends Controller
{
    ...
    public function store(StoreCashierShiftRequest $request): RedirectResponse
    {
        ...
        $this->auditLogService->log(
            ...
            auditable: $shift,
            description: 'Shift cashier dibuka.',
        ...
        return redirect($target)->with('success', 'Shift cashier successfully dibuka.');
    }
    ...
    public function close(CloseCashierShiftRequest $request, CashierShift $cashierShift, ConfirmPasswordForForceCloseRequest $confirmPasswordRequest): RedirectResponse
    {
        ...
        $this->auditLogService->log(
            ...
            description: $forceClose ? 'Shift cashier ditutup paksa.' : 'Shift cashier ditutup.',
            before: $before,
        ...
        return to_route('cashier-shifts.show', $closedShift)->with('success', 'Shift cashier successfully ditutup.');
    }
