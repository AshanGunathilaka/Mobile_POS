...
class StockMutationService
{
    ...
    public function recordInitialStock(Product $product, ?int $userId = null, ?int $warehouseId = null): ?StockMutation
    {
        ...
        $this->auditLogService->log(
            ...
            module: 'stock',
            auditable: $product,
            description: 'Initial product stock recorded.',
            before: [
                'product_id' => $product->id,
                'stock_before' => 0,
                'stock_after' => 0,
    ...
    public function recordStockOpnameAdjustment(
        ...
        $this->auditLogService->log(
            ...
            module: 'stock',
            auditable: $product,
            description: 'Stock product disesuaikan melalui stock opname.',
            before: [
                'product_id' => $product->id,
                'stock_before' => $stockBefore,
    ...
    public function recordPurchaseInbound(
        ...
        $mutation = StockMutation::create([
            ...
            'stock_before' => $stockBefore,
            'stock_after' => $stockAfter,
            'notes' => $notes ?: 'Stock added from goods receiving.',
            'created_by' => $userId,
        ]);
        ...
        $this->auditLogService->log(
            ...
            module: 'stock',
            auditable: $product,
            description: 'Stock added from goods receiving '.$goodsReceiving->document_number,
            before: [
                'product_id' => $product->id,
                'stock_before' => $stockBefore,
                'stock_after' => $stockBefore,
    ...
    public function recordSupplierReturnOut(
        ...
        $mutation = StockMutation::create([
            ...
            'stock_before' => $stockBefore,
            'stock_after' => $stockAfter,
            'notes' => $notes ?: 'Returned goods to supplier.',
            'created_by' => $userId,
        ]);
