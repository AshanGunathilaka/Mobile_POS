    ...
    public function defaultAutoSegments(): array
    {
        return [
            ...
            [
                ...
                'slug' => 'frequent_buyer',
                'type' => CustomerSegment::TYPE_AUTO,
                'description' => 'Customers who shop frequently.',
            ...
            [
                ...
                'type' => CustomerSegment::TYPE_AUTO,
                'description' => 'Customers who have not purchased again for a long time.',
                'auto_rule_type' => CustomerSegment::RULE_PURCHASE_FREQUENCY,
                'rule_config' => [
            ...
            [
                ...
                'type' => CustomerSegment::TYPE_AUTO,
                'description' => 'Customers with active receivables.',
            ...
            [
                ...
                'type' => CustomerSegment::TYPE_AUTO,
                'description' => 'Customers with due or overdue receivables.',
                'auto_rule_type' => CustomerSegment::RULE_RECEIVABLE_BEHAVIOR,
                'rule_config' => [
                    'overdue_only' => true,
                ],
