    ...
    public function createReturn(array $data, array $items, int $userId): SupplierReturn
    {
        return DB::transaction(function () use ($data, $items, $userId) {
            ...
            $this->auditLogService->log(
                ...
                module: 'purchase',
                auditable: $return,
                description: 'Supplier return '.$return->document_number.' created.',
                after: [
        ...
        DB::transaction(function () use ($return) {
            ...
            foreach ($return->items as $item) {
                ...
                $this->stockMutationService->recordSupplierReturnOut(
                    ...
                    notes: $item->reason ?? 'Returned goods to supplier',
            ...
            $this->auditLogService->log(
                ...
                module: 'purchase',
                auditable: $return,
                description: 'Supplier return '.$return->document_number.' completed. Stock was reduced and the payable was adjusted.',
    ...
    public function cancel(SupplierReturn $return): void
    {
        DB::transaction(function () use ($return) {
            ...
            $this->auditLogService->log(
                ...
                module: 'purchase',
                auditable: $return,
                description: 'Supplier return '.$return->document_number.' cancelled.',
