...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'REST API for Dikasir, an open-source POS system for Sri Lankan small businesses. '
            .'All endpoints except login, registration, and webhooks require a bearer token from POST /api/v1/auth/login.',
    ],
