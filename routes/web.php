...
Route::get('/features', fn () => Inertia::render('Public/Features'))->name('features.index');
Route::get('/documentation', fn () => Inertia::render('Public/Documentation'))->name('documentation.index');
Route::get('/roadmap', fn () => Inertia::render('Public/Roadmap'))->name('roadmap.index');
Route::get('/contributing', fn () => Inertia::render('Public/Contributing'))->name('contributing.index');
Route::redirect('/fitur', '/features');
Route::redirect('/dokumentasi', '/documentation');
Route::redirect('/kontribusi', '/contributing');
